...
- Triggers: `workflow_dispatch` + two crons (UTC): `*/15 14-19 * * *` (dense window around the ~11am ET refresh) and `0 0-13,20-23 * * *` (hourly sweep otherwise). Free on a public repo; Actions cron jitter is fine given daily upstream cadence.
